package com.jhonjson.base_library.utils
...
object StatusUtils {
     ...
     */
    var defaultColor_21: Int = ColorUtils.parseColor("#33000000")
    ...
    fun setSystemStatus(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            val contentView = activity.window
