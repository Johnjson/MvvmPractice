package com.jhonjson.base_library.http.log;
 ...
 * @date 2020-07-27
 * @author jhonjson
 * @describe OkHttp拦截器，主要用于打印日志
 */
public class HttpLognterceptor implements Interceptor {
    ...
    public HttpLognterceptor(String tag) {
